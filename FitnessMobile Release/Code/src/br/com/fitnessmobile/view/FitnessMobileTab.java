...
public class FitnessMobileTab extends TabActivity implements OnTabChangeListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("tab_usu�rio").setIndicator("Medidas",getResources().getDrawable(R.drawable.ico_tab_exer)).setContent(intent));
    ...
    /*public void onTabChanged(String tabId) {
        Log.i("log Aba", "Trocou aba: "+tabId);
