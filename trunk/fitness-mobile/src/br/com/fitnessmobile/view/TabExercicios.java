...
public class TabExercicios extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.spinnerGrupoMuscular.setAdapter(arrayAdapter);
	...
	private void instanciarViews() {
		...
		this.spinnerGrupoMuscular = (Spinner) findViewById(R.id.sp_grupo_muscular);
		this.btnAddExercicio = (Button) findViewById(R.id.btn_add_exercicio);
		this.btnAddExercicio.setOnClickListener(this);
