...
public class FitnessMobileTab extends TabActivity implements OnTabChangeListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("tab_modo_visualizacao").setIndicator("Modo de Visualização",getResources().getDrawable(R.drawable.ico_tab_exer)).setContent(intent));
