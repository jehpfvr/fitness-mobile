...
public class FitnessMobileMain extends Activity implements OnClickListener{
	...
	private Button btnModoVisualizacao;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.btnModoVisualizacao = (Button) findViewById(R.id.btn_main_modo_de_visualizacao);
		this.btnModoVisualizacao.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		}else if(v == btnModoVisualizacao){
			startActivity(new Intent(this,TabModoVisualizacao.class));
		}
